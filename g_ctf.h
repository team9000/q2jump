...
// draxi: changed CS_AIRACCEL- to CS_JUMP+
#define CONFIG_JUMP_KEY_FORWARD	(CS_JUMP+1)
#define CONFIG_JUMP_KEY_LEFT	(CS_JUMP+2)
//#define CONFIG_JUMP_KEY_FPS	(CS_JUMP+3)
#define CONFIG_JUMP_KEY_RIGHT	(CS_JUMP+4)
#define CONFIG_JUMP_KEY_BACK	(CS_JUMP+5)
#define CONFIG_JUMP_KEY_JUMP	(CS_JUMP+6)
#define CONFIG_JUMP_KEY_CROUCH	(CS_JUMP+7)
#define CONFIG_JUMP_KEY_ATTACK	(CS_JUMP+8)   //draxi
//
...
//#define	STAT_SELECTED_ITEM		12 in use
...
// draxi
// #define STAT_JUMP_ANTIGLUE 16 // Took it away to use the ATTACK! string instead, 
// and took this one since antiglue isn't used anymore! 
// Also lowered the Team, Jumpers and Race indicators @ g_ctf.c(184) !
...
#define STAT_JUMP_KEY_ATTACK 16  // draxi
...
//draxi Race + number
#define CONFIG_JUMP_RACE_1 (CS_JUMP+9)
#define CONFIG_JUMP_RACE_2 (CS_JUMP+10)
#define CONFIG_JUMP_RACE_3 (CS_JUMP+11)
#define CONFIG_JUMP_RACE_4 (CS_JUMP+12)
#define CONFIG_JUMP_RACE_5 (CS_JUMP+13)
#define CONFIG_JUMP_RACE_6 (CS_JUMP+14)
#define CONFIG_JUMP_RACE_7 (CS_JUMP+15)
#define CONFIG_JUMP_RACE_8 (CS_JUMP+16)
#define CONFIG_JUMP_RACE_9 (CS_JUMP+17)
#define CONFIG_JUMP_RACE_10 (CS_JUMP+18)
#define CONFIG_JUMP_RACE_11 (CS_JUMP+19)
#define CONFIG_JUMP_RACE_12 (CS_JUMP+20)
#define CONFIG_JUMP_RACE_13 (CS_JUMP+21)
#define CONFIG_JUMP_RACE_14 (CS_JUMP+22)
#define CONFIG_JUMP_RACE_15 (CS_JUMP+23)
#define CONFIG_JUMP_RACE_NOW (CS_JUMP+24)
