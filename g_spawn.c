...
//		gi.configstring (CONFIG_JUMP_KEY_FPS, "fps");
		...
		gi.configstring (CONFIG_JUMP_KEY_ATTACK,       "  ATTACK!   ");  // draxi
...
//		gi.configstring (CONFIG_JUMP_ANTIGLUE_DISABLED,"Antiglue  Î¯Á");
		...
		gi.configstring (CONFIG_JUMP_JUMPERS_ON,       " Jumpers   ÏÎ");
		gi.configstring (CONFIG_JUMP_JUMPERS_OFF,      " Jumpers  ÏÆÆ");

		// draxi, changed "Race ON" to "Race (number)"
		gi.configstring (CONFIG_JUMP_RACE_ON,          "    Race   ÏÎ");
		gi.configstring (CONFIG_JUMP_RACE_NOW,          "    Race   ÎÏ×");
		
		gi.configstring (CONFIG_JUMP_RACE_1,          "    Race   ±");
		gi.configstring (CONFIG_JUMP_RACE_2,          "    Race   ²");
		gi.configstring (CONFIG_JUMP_RACE_3,          "    Race   ³");
		gi.configstring (CONFIG_JUMP_RACE_4,          "    Race   ´");
		gi.configstring (CONFIG_JUMP_RACE_5,          "    Race   µ");
		gi.configstring (CONFIG_JUMP_RACE_6,          "    Race   ¶");
		gi.configstring (CONFIG_JUMP_RACE_7,          "    Race   ·");
		gi.configstring (CONFIG_JUMP_RACE_8,          "    Race   ¸");
		gi.configstring (CONFIG_JUMP_RACE_9,          "    Race   ¹");
		gi.configstring (CONFIG_JUMP_RACE_10,          "    Race   ±°");
		gi.configstring (CONFIG_JUMP_RACE_11,          "    Race   ±±");
		gi.configstring (CONFIG_JUMP_RACE_12,          "    Race   ±²");
		gi.configstring (CONFIG_JUMP_RACE_13,          "    Race   ±³");
		gi.configstring (CONFIG_JUMP_RACE_14,          "    Race   ±´");
		gi.configstring (CONFIG_JUMP_RACE_15,          "    Race   vµ");
		
		/// end


		gi.configstring (CONFIG_JUMP_RACE_OFF,         "    Race  ÏÆÆ");
