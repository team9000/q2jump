...
void		delete_nottop10(edict_t *ent); //draxi
...
#define HTML_TEMPLATE_WEEK "$template_week$"
...
#define RECORD_KEY_ATTACK  64 << RECORD_KEY_SHIFT   //draxi
